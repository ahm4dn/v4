...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/ahm4dn/izin/main/ipvps > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/ahm4dn/izin/main/ipvps | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/ahm4dn/izin/main/ipvps | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/ahm4dn/izin/main/ipvps | grep $MYIP | awk '{print $3}')
fi
...
clear 
figlet 'TrenaDM StoreVPN' | lolcat
echo -e "  ${z}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m${NC}"
...
echo -e "  ${z}│ [${r}06${NC}] ${z}UPDATE SCRIPT${NC}       ""[${r}00${NC}] ${z}KELUAR SCRIPT      ${NC}"
echo -e "  ${z}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m${NC}"
echo -e "${z}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m${NC}" 
