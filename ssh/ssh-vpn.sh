...
curl -sS https://raw.githubusercontent.com/ahm4dn/v4/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/ahm4dn/v4/main/ssh/nginx.conf"
mkdir -p /home/vps/public_html
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/ahm4dn/v4/main/ssh/newudpgw"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/ahm4dn/v4/main/issue.net"
chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/ahm4dn/v4/main/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -O menu-backup "https://raw.githubusercontent.com/ahm4dn/v4/main/backup/menu-backup.sh"
...
# change port
wget -O port-ssl "https://raw.githubusercontent.com/ahm4dn/v4/main/port/port-ssl.sh"
wget -O port-ovpn "https://raw.githubusercontent.com/ahm4dn/v4/main/port/port-ovpn.sh"


wget -O xp "https://raw.githubusercontent.com/ahm4dn/v4/main/ssh/xp.sh"
wget -O acs-set "https://raw.githubusercontent.com/ahm4dn/v4/main/acs-set.sh"

wget -O sshws "https://raw.githubusercontent.com/ahm4dn/v4/main/ssh/sshws.sh"
wget -O updatemenu "https://raw.githubusercontent.com/ahm4dn/v4/main/updatemenu.sh"
